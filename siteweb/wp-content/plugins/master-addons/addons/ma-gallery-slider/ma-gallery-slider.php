...
class JLTMA_Gallery_Slider extends Widget_Base
{
	...
	{
		return esc_html__('Gallery Slider', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Gallery', JLTMA_TD)
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Add Images', JLTMA_TD),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Thumbnails', JLTMA_TD),
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__('Thumbnails Size', JLTMA_TD),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Ordering', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					''     => esc_html__('Default', JLTMA_TD),
					'rand' => esc_html__('Random', JLTMA_TD),
				],
				'default'   => '',
				'condition' => [
					'jltma_gallery_slider_show_thumbnails' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Caption', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''            => esc_html__('None', JLTMA_TD),
					'title'       => esc_html__('Title', JLTMA_TD),
					'caption'     => esc_html__('Caption', JLTMA_TD),
					'description' => esc_html__('Description', JLTMA_TD),
				],
				'condition' => [
					'jltma_gallery_slider_show_thumbnails' => 'yes'
				],
		...
		$this->add_control(
			...
			[
				'type'           => Controls_Manager::SELECT,
				'label'          => __('Orientation', JLTMA_TD),
				'default'        => 'horizontal',
				'tablet_default' => 'horizontal',
				'mobile_default' => 'horizontal',
				'options'        => [
					'horizontal' => __('Horizontal', JLTMA_TD),
					'vertical'   => __('Vertical', JLTMA_TD),
				],
				'condition' 		=> [
					'jltma_gallery_slider_show_thumbnails'      => 'yes',
					'jltma_gallery_slider_thumbnails_carousel!' => '',
		...
		$this->add_responsive_control(
			...
			[
				'label'          => esc_html__('Slides Per View', JLTMA_TD),
				'type'           => Controls_Manager::SELECT,
				'default'        => '',
				'tablet_default' => '',
				'mobile_default' => '',
		...
		$this->add_responsive_control(
			...
			[
				'type'      => Controls_Manager::SELECT,
				'label'     => __('Slides to Scroll', JLTMA_TD),
				'options'   => ['' => __('Default', JLTMA_TD)] + $slides_per_column,
				'condition' => [
					'jltma_gallery_slider_show_thumbnails'      => 'yes',
					'jltma_gallery_slider_thumbnails_carousel!' => '',
		...
		$this->add_control(
			'carousel_resistance',
			[
				'label'       => __('Resistance', JLTMA_TD),
				'description' => __('Set the value for resistant bounds.', JLTMA_TD),
				'type'        => Controls_Manager::SLIDER,
				'default'     => [
					'size' => 0.25,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Speed (ms)', JLTMA_TD),
				'description' => __('Duration of the effect transition.', JLTMA_TD),
				'type'        => Controls_Manager::SLIDER,
				'default'     => [
					'size' => 500,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'type'               => Controls_Manager::SWITCHER,
				'label'              => esc_html__('Arrows', JLTMA_TD),
				'default'            => '',
				'label_off'          => esc_html__('Hide', JLTMA_TD),
				'label_on'           => esc_html__('Show', JLTMA_TD),
				'return_value'       => 'yes',
		...
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::SELECT,
				'label'   => __('Arrow Position', JLTMA_TD),
				'default' => 'middle',
				'options' => [
					'top'    => __('Top', JLTMA_TD),
					'middle' => __('Middle', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Autoplay', JLTMA_TD),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => '',
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Infinite Loop', JLTMA_TD),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => '',
				'label_on'           => esc_html__('Yes', JLTMA_TD),
				'label_off'          => esc_html__('No', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Direction', JLTMA_TD),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options'     => [
					'ltr' 			=> [
						'title' => esc_html__('Left to Right', JLTMA_TD),
						'icon'  => 'eicon-h-align-right',
					],
					'rtl' 			=> [
						'title' => esc_html__('Right to Left', JLTMA_TD),
						'icon'  => 'eicon-h-align-left',
					],
				],
				'default'        => 'ltr',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Preview', JLTMA_TD),
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'   => esc_html__('Preview Size', JLTMA_TD),
				'default' => 'full',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Link to', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none'   => esc_html__('None', JLTMA_TD),
					'file'   => esc_html__('Media File', JLTMA_TD),
					'custom' => esc_html__('Custom URL', JLTMA_TD),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__('https://your-link.com', JLTMA_TD),
				'condition'   => [
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__('Lightbox', JLTMA_TD),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'label_on'     => esc_html__('Yes', JLTMA_TD),
				'label_off'    => esc_html__('No', JLTMA_TD),
		...
		// 	[
		// 		'label' 			=> esc_html__('Image Stretch', JLTMA_TD),
		// 		'type' 				=> Controls_Manager::SWITCHER,
		// 		'default'           => 'yes',
		// 		'label_on'          => esc_html__('Yes', JLTMA_TD),
		// 		'label_off'         => esc_html__('No', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__('Auto Height', JLTMA_TD),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'yes',
				'label_on'           => esc_html__('Yes', JLTMA_TD),
				'label_off'          => esc_html__('No', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'              => __('Disable on Interaction', JLTMA_TD),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => '',
				'frontend_available' => true,
				'condition'          => [
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Effect', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__('Slide', JLTMA_TD),
					'fade'      => esc_html__('Fade', JLTMA_TD),
					'cube'      => esc_html__('Cube', JLTMA_TD),
					'flip'      => esc_html__('Flip', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'              => __('Speed (ms)', JLTMA_TD),
				'description'        => __('How long should the effect transition last.', JLTMA_TD),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 1000,
				'min'                => 0,
				'max'                => 2000,
		...
		$this->add_control(
			...
			[
				'label'       => __('Transform Origin', JLTMA_TD),
				'type'        => Controls_Manager::SELECT,
				'separator'   => 'before',
				'label_block' => true,
				'options'     => [
		...
		$this->add_control(
			...
			[
				'label'   => __('X Anchor Point', JLTMA_TD),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => [
					'left' 	=> [
		...
		$this->add_control(
			...
			[
				'label'          => esc_html__('Preview Position', JLTMA_TD),
				'type'           => Controls_Manager::SELECT,
				'default'        => 'left',
				'tablet_default' => 'top',
				'mobile_default' => 'top',
		...
		$this->add_control(
			...
			[
				...
				'options'        => [
					...
					'mobile' => esc_html__('Mobile Only', JLTMA_TD),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Preview Width (%)', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' 	=> [
						'min' => 0,
		...
		$this->add_responsive_control(
			'carousel_width',
			[
				'label'      => __('Carousel Width', JLTMA_TD),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range'      => [
					'px' 	=> [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Image Border', JLTMA_TD),
		...
		$this->start_controls_tab('jltma_gallery_slider_arrows_tab_default', [
			'label'     => esc_html__('Default', JLTMA_TD),
			'condition' => [
				'jltma_gallery_slider_show_arrows!' => '',
			]
		]);
		...
		$this->start_controls_tab('jltma_gallery_slider_arrows_tab_disabled', [
			'label'     => esc_html__('Disabled', JLTMA_TD),
			'condition' => [
				'jltma_gallery_slider_show_arrows!' => '',
			]
		]);
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Preview Captions', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'jltma_gallery_slider_caption_type!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Vertical Align', JLTMA_TD),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					'top' 	=> [
					...
					'middle' 		=> [
						'title' => esc_html__('Middle', JLTMA_TD),
						'icon'  => 'eicon-v-align-middle',
					],
					'bottom' 		=> [
						'title' => esc_html__('Bottom', JLTMA_TD),
						'icon'  => 'eicon-v-align-bottom',
					],
				],
				'default'   => 'bottom',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Horizontal Align', JLTMA_TD),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					'left' 	=> [
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Text Align', JLTMA_TD),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					'left' 	=> [
						'title' => esc_html__('Left', JLTMA_TD),
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Preview Hover Effects', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'jltma_gallery_slider_caption_type!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Captions', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'condition' => [
					'jltma_gallery_slider_caption_type!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''                 => esc_html__('None', JLTMA_TD),
					'fade-in'          => esc_html__('Fade In', JLTMA_TD),
					'fade-out'         => esc_html__('Fade Out', JLTMA_TD),
					'from-top'         => esc_html__('From Top', JLTMA_TD),
					'from-right'       => esc_html__('From Right', JLTMA_TD),
					'from-bottom'      => esc_html__('From Bottom', JLTMA_TD),
					'from-left'        => esc_html__('From Left', JLTMA_TD),
					'fade-from-top'    => esc_html__('Fade From Top', JLTMA_TD),
					'fade-from-right'  => esc_html__('Fade From Right', JLTMA_TD),
					'fade-from-bottom' => esc_html__('Fade From Bottom', JLTMA_TD),
					'fade-from-left'   => esc_html__('Fade From Left', JLTMA_TD),
					'to-top'           => esc_html__('To Top', JLTMA_TD),
					'to-right'         => esc_html__('To Right', JLTMA_TD),
					'to-bottom'        => esc_html__('To Bottom', JLTMA_TD),
					'to-left'          => esc_html__('To Left', JLTMA_TD),
					'fade-to-top'      => esc_html__('Fade To Top', JLTMA_TD),
					'fade-to-right'    => esc_html__('Fade To Right', JLTMA_TD),
					'fade-to-bottom'   => esc_html__('Fade To Bottom', JLTMA_TD),
					'fade-to-left'     => esc_html__('Fade To Left', JLTMA_TD),
				],
				'condition' 	=> [
					'jltma_gallery_slider_caption_type!'               => '',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Horizontal spacing', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' 	=> [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Thumbnails Captions', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'jltma_gallery_slider_thumbnails_caption_type!' => '',
					'jltma_gallery_slider_show_thumbnails'          => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Thumbnail Slider', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'jltma_gallery_slider_show_thumbnails'      => 'yes',
					'jltma_gallery_slider_thumbnails_carousel!' => '',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Thumb Container', JLTMA_TD),
				'separator' => 'before',
				'type'      => Controls_Manager::HEADING,
				'condition' => [
					'jltma_gallery_slider_thumb_show_arrows!' => '',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Navigation Width', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' 		=> [
						'min' => 40,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Navigation Height', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' 		=> [
						'min' => 55,
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Thumbnails Hover Effects', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'jltma_gallery_slider_show_thumbnails' => 'yes',
				],
		...
		$this->start_controls_tab('jltma_gallery_slider_image_style_default', ['label' => esc_html__('Default', JLTMA_TD),]);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Scale', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' 		=> [
						'min'  => 1,
		...
		$this->start_controls_tab('jltma_gallery_slider_image_style_hover', ['label' 	=> esc_html__('Hover', JLTMA_TD),]);
		...
		$this->start_controls_tab('jltma_gallery_slider_image_style_active', ['label' 	=> esc_html__('Active', JLTMA_TD),]);
		...
		$this->start_controls_tab('jltma_gallery_slider_overlay_style_default', ['label' => esc_html__('Default', JLTMA_TD)]);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Blend mode', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'normal'      => esc_html__('Normal', JLTMA_TD),
					'multiply'    => esc_html__('Multiply', JLTMA_TD),
					'screen'      => esc_html__('Screen', JLTMA_TD),
					'overlay'     => esc_html__('Overlay', JLTMA_TD),
					'darken'      => esc_html__('Darken', JLTMA_TD),
					'lighten'     => esc_html__('Lighten', JLTMA_TD),
					'color'       => esc_html__('Color', JLTMA_TD),
					'color-dodge' => esc_html__('Color Dodge', JLTMA_TD),
					'hue'         => esc_html__('Hue', JLTMA_TD),
				],
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('Please check blend mode support for your browser %1$s here %2$s', JLTMA_TD), '<a href="https://caniuse.com/#search=mix-blend-mode" target="_blank">', '</a>'),
		...
		$this->start_controls_tab('jltma_gallery_slider_overlay_style_hover', ['label' => esc_html__('Hover', JLTMA_TD)]);
		...
		$this->start_controls_tab('jltma_gallery_slider_overlay_style_active', ['label' => esc_html__('Active', JLTMA_TD)]);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/gallery-slider/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/gallery-slider-for-elementor/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
