...
class JLTMA_Domain_Search extends Widget_Base
{
    ...
    {
        return esc_html__('Domain Checker', JLTMA_TD);
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('General', JLTMA_TD),
            ]
        );
        ...
        $this->add_control(
            'palceholder_text',
            array(
                'label'       => __('Input Placeholder', JLTMA_TD),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Button Link?', JLTMA_TD),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Messages', JLTMA_TD),
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => __('Congratulations! %s is available!', JLTMA_TD),
                'description' => __('Attention: %s is required to print dynamic data. It will print Domain name.', JLTMA_TD),
                'label_block' => true
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => __('Sorry! %s is already taken!', JLTMA_TD),
                'description' => __('Attention: %s is required to print dynamic data. It will print Domain name.', JLTMA_TD),
                'label_block' => true
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => __('Not Found', JLTMA_TD),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => __('WHOIS server not found for that TLD.', JLTMA_TD),
                'label_block' => true
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'       => __('Not Entered Domain Name', JLTMA_TD),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => __('Please Enter a Domain name.', JLTMA_TD),
                'label_block' => true
            )
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Affiliation', JLTMA_TD),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Show Affiliate Link?', JLTMA_TD),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            array(
                'label'       => __('Affiliate Text', JLTMA_TD),
                'type'        => Controls_Manager::TEXT,
        ...
        $this->add_control(
            ...
            array(
                'label'       => __('Affiliate Link', JLTMA_TD),
                'type'        => Controls_Manager::URL,
                'dynamic'     => ['active' => true],
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/domain-search/" target="_blank" rel="noopener">', '</a>'),
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/how-ma-domain-checker-works/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
                'content_classes' => 'jltma-editor-doc-links',
            ]
        );
        ...
        //     [
        //         'type'            => Controls_Manager::RAW_HTML,
        //         'raw'             => sprintf( esc_html__( '%1$s Watch Video Tutorial %2$s', JLTMA_TD ), '<a href="https://www.youtube.com/watch?v=4xAaKRoGV_o" target="_blank" rel="noopener">', '</a>' ),
        //         'content_classes' => 'jltma-editor-doc-links',
        //     ]
        // );
        $this->end_controls_section();
                        ...
                        <div class="jltma-input-group mb-3">
                            ...
                            <div class="jltma-input-group-append">
                                ...
                                <button type="submit" <?php //echo $this->get_render_attribute_string('submit-button');
                                                        ?> class="jltma-btn jltma-btn-dark domain-checker jltma-button jltma-btn-loader">
                                    <span>
