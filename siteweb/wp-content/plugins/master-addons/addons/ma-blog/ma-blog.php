...
?>
		<i class="jltma-blog-post-format-icon fa fa-<?php echo $post_format; ?>"></i>
		<?php
	}
							...
							<?php if (
								...
								<?php if ($settings['ma_el_post_grid_layout'] == 'list' && $settings['ma_el_post_list_layout'] == 'classic') { ?>
									...
									<?php if ($settings['ma_el_post_grid_layout'] == 'list' && $settings['ma_el_post_list_layout'] == 'meta_bg') { ?>
										...
										<div class="jltma-blog-effect-container <?php echo 'jltma-blog-' . $post_effect . '-effect'; ?>">
					...
					?>
						...
						<?php if ($settings['ma_el_post_grid_thumbnail'] == 'yes') { ?>
							<div <?php echo $this->get_render_attribute_string('hover_animations'); ?>>
								<div class="jltma-post-thumbnail jltma-img-<?php echo $image_effect; ?> jltma-img-shape-<?php echo $settings['ma_el_blog_image_shapes']; ?>">
				...
				protected function render()
				{
					...
					if (!$carousel) {
						...
						$this->add_render_attribute(
							...
							[
								'jltma-blog-wrapper',
								'jltma-blog-' . $settings['ma_el_post_grid_layout'],
								'jltma-row'
							]
						);
					} else {
