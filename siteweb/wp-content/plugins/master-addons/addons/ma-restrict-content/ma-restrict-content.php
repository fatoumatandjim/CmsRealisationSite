...
class JLTMA_Restrict_Content extends Widget_Base
{
	...
	{
		return __('Restrict Content', JLTMA_TD);
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Restrict Type', JLTMA_TD)
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => 'onpage',
				'options'     => [
					'onpage'     		=> __('On Page', JLTMA_TD),
					'popup'     		=> __('Popup', JLTMA_TD)
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => 'user',
				'options'     => [
					'user'      		=> __('User Based', JLTMA_TD),
					'password'  		=> __('Password Based', JLTMA_TD),
					'age_restrict'      => __('Age Restriction', JLTMA_TD),
					'math_captcha'      => __('Math Captcha', JLTMA_TD)
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __('Math Type', JLTMA_TD),
				'label_block' => false,
				'type'        => Controls_Manager::SELECT,
				'default'     => 'add',
				'options'     => [
					'add'      			=> __('Add', JLTMA_TD),
					'subtract'  		=> __('Subtract', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'       => __('Select User Roles', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'     => __('Set Password', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'       => __('Age Restrict Type', JLTMA_TD),
				'label_block' => false,
				'type'        => Controls_Manager::SELECT,
				'default'     => 'input_age',
				'options'     => [
					'input_age'      		=> __('Select Birthday', JLTMA_TD),
					'enter_age'     		=> __('Enter Age', JLTMA_TD),
					'age_checkbox'     		=> __('Checkbox', JLTMA_TD),
					'button_confirm'     	=> __('Submit Confirm', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'       => __('Popup Type', JLTMA_TD),
				'label_block' => false,
				'type'        => Controls_Manager::SELECT,
				'default'     => 'default',
				'options'     => [
					'default'     			=> __('Default Modal (Button Click)', JLTMA_TD),
					'windowload'     		=> __('Window Load & Default Modal', JLTMA_TD),
					'buttonfullscreen'     	=> __('Button Click & Full Screen', JLTMA_TD),
					'windowloadfullscreen'  => __('Window Load & Full Screen', JLTMA_TD)
				],
				'condition' => [
					'ma_el_restrict_content_layout_type' => ['popup']
				]
		...
		$this->add_control(
			...
			[
				'label'     => __('Show in Editor', JLTMA_TD),
		...
		// 	[
		// 		'label'     => __( 'Popup Animation', JLTMA_TD ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Restrict Content', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __('Select Source', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'custom',
				'options' => [
					'custom'         => __('Custom Content', JLTMA_TD),
					'elementor'      => __('Elementor Template', JLTMA_TD)
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __('Custom Content', JLTMA_TD),
				'type'        => Controls_Manager::WYSIWYG,
				'label_block' => true,
				'dynamic'     => ['active' => true],
				'default'     => __('This is your content that you want to be restricted by either user role or password.', JLTMA_TD),
				'condition'   => [
		...
		$this->add_control(
			...
			[
				'label'       => __('Show Forcefully for Edit', JLTMA_TD),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __('You can show your restricted content in editor for design it.', JLTMA_TD),
				'condition'   => [
					'ma_el_restrict_content_type'	=> 'password'
				]
			]
		...
		// 	[
		// 		'label' => __( 'Age Restric Contents', JLTMA_TD ),
		// 		'condition' => [
		// 			'ma_el_restrict_content_type' 	=> 'age_restrict',
		...
		*/
		$this->start_controls_section(
			'ma_el_password_field',
			[
				'label' => __('Password Field', JLTMA_TD),
				'condition'   => ['ma_el_restrict_content_type' => 'password'],
			]
		);
		$this->add_control(
			'ma_el_password_field_placeholder',
			[
				'label'       => __('Placeholder Text', JLTMA_TD),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __('Enter Password', JLTMA_TD),
				'default'     => __('Enter Password', JLTMA_TD),
				'separator'   => 'before',
				'condition'   => ['ma_el_restrict_content_type' => 'password'],
			]
		);
		...
		*/
		$this->start_controls_section(
			...
			[
				'label' => __('Warning Message', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			'ma_el_warning_type',
			[
				'label'   => __('Message Type', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'custom',
				'options' => [
					'custom'         => __('Custom Message', JLTMA_TD),
					'elementor'      => __('Elementor Template', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label'     => __('Custom Title', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => __('Age Verification', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'     => __('Custom Message', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => __('You don\'t have permission to see this content.', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
					'ma_el_warning_type' => 'custom',
				]
		...
		$this->add_control(
			...
			[
				'label'     => __('Checkbox Message', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => __('I confirm that I am 18 years old or over', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
		...
		$this->add_control(
			'ma_el_warning_show',
			[
				'label'   => __('Show Warnings?', JLTMA_TD),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __('Popup Button', JLTMA_TD),
				'type'      => Controls_Manager::TEXT,
				'default'   => __('Open Content', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
					'ma_el_restrict_content_layout_type' => 'popup'
				]
		...
		$this->add_control(
			'ma_el_exit_button',
			[
				'label'     => __('Exit Button', JLTMA_TD),
				'type'      => Controls_Manager::TEXT,
				'default'   => __('Exit', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Error Message', JLTMA_TD),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __('Empty Birthday Message', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => __('Please enter your birthday', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
					'ma_el_restrict_content_type' => 'age_restrict',
		...
		$this->add_control(
			...
			[
				'label'     => __('Non Exist Date', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => esc_html__('Oops it looks like that date doesn\'t exist.', JLTMA_TD),
				'dynamic'   => ['active' => true],
				'condition' => [
					'ma_el_restrict_content_type' => 'age_restrict',
					'ma_el_restrict_age_type' => ['input_age']
		...
		$this->add_control(
			...
			[
				'label'     => __('Error Message', JLTMA_TD),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => __('Please confirm if you are 18 years old or over.', JLTMA_TD),
				'dynamic'   => ['active' => true]
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Restrict Content', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-message .ma-el-alert' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jltma-restrict-content-wrap .jltma-restrict-content-fields' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-message .ma-el-alert' => 'background: {{VALUE}};',
					'{{WRAPPER}} .jltma-restrict-content-wrap .jltma-restrict-content-fields' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-message .ma-el-alert' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .jltma-restrict-content-wrap .jltma-restrict-content-fields' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-message .ma-el-alert' => 'Margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .jltma-restrict-content-wrap .jltma-restrict-content-fields' => 'Margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-message .ma-el-alert',
					'{{WRAPPER}} .jltma-restrict-content-wrap .jltma-restrict-content-fields',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Select Box Background', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'.jltma_ra_select, .jltma_ra_options.jltma_ra_active' => 'background: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Select Box Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Message Contents', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'ma_el_warning_type' => 'custom'
				]
		...
		$this->add_control(
			...
			[
				'label'     => __('Label Warning', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-form label.jltma_rc_answer,
						{{WRAPPER}} .jltma-restrict-form label.ma_el_ra_input_year' => 'color: {{VALUE}};'
				],
				'condition' => [
					'ma_el_warning_type' 			=> 'custom',
					'ma_el_restrict_content_type'	=> ['math_captcha', 'age_restrict'],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-form label.jltma_rc_answer, {{WRAPPER}} .jltma-restrict-form label.ma_el_ra_input_year',
				'condition' => [
					'ma_el_warning_type' 			=> 'custom',
					'ma_el_restrict_content_type'	=> ['math_captcha', 'age_restrict'],
					'ma_el_restrict_age_type'		=> 'enter_age'
		...
		$this->add_control(
			...
			[
				'label'     => __('Title Warning', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ma_el_warning_type' 			=> 'custom',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-form .card-title,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-title,
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ma-el-alert .elementor-alert-title,{{WRAPPER}} .jltma-restrict-form .card-title, {{WRAPPER}} .jltma-restrict-modal .card-title,{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-title'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-message-text .ma-el-alert,
						{{WRAPPER}} .jltma-restrict-form .card-text,
						{{WRAPPER}} {{CURRENT_ITEM}} .elementor-alert-description,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-text' => 'color: {{VALUE}};'
				]
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ma-el-alert .elementor-alert-description, {{WRAPPER}} .jltma-restrict-form .card-text,{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-text',
				'separator' => 'after',
			]
		);
		...
		// Input Age Controls
		$this->add_control(
			'ma_el_rc_input_age_heading',
			[
				'label'     => __('Age Restriction Fields', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ma_el_restrict_content_type' => ['age_restrict'],
					'ma_el_restrict_age_type'     => ['input_age', 'enter_age']
				]
			]
		);

		$this->add_responsive_control(
			'ma_el_rc_input_age_field_width',
			[
				'label'   => __('Field Width', JLTMA_TD),
				...
				'selectors' => [
					'{{WRAPPER}} .jltma_ra_select_wrap,
					{{WRAPPER}} .jltma-restrict-content-wrap .form-group.jltma_rc_year input,
					{{WRAPPER}} .jltma-restrict-content-wrap .form-group .jltma-input-pass,
					{{WRAPPER}} .jltma-restrict-form .form-group .jltma-input-pass,
					{{WRAPPER}} .jltma-restrict-form .form-group.jltma_rc_year input' => 'width: calc( {{SIZE}}{{UNIT}} - 20px );',
				],
				'condition' => [
					'ma_el_restrict_content_type' => ['age_restrict'],
					'ma_el_restrict_age_type'     => ['input_age', 'enter_age']
		...
		// Password based Age Controls
		$this->add_control(
			'ma_el_rc_password_age_heading',
			[
				'label'     => __('Password Field', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->add_responsive_control(
			'ma_el_rc_password_age_field_width',
			[
				'label'   => __('Field Width', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-form .form-group .jltma-input-pass' => 'width:{{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'ma_el_restrict_content_type' => ['password']
				]
		...
		// Math Captch Controls
		$this->add_control(
			'ma_el_rc_match_captch_age_heading',
			[
				'label'     => __('Math Captha Field', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ma_el_restrict_content_type' => ['math_captcha']
		...
		$this->add_responsive_control(
			'ma_el_rc_math_captcha_age_field_width',
			[
				'label'   => __('Field Width', JLTMA_TD),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-wrap .form-group.jltma_rc_answer input' => 'width:{{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'ma_el_restrict_content_type' => ['math_captcha']
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-form .card-body,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-body' => 'color: {{VALUE}};'
				],
				'condition' => [
					'ma_el_restrict_content_type'	=> 'age_restrict',
					'ma_el_restrict_age_type'	=> ['age_checkbox', 'button_confirm']
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-form .card-body, {{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .card-body',
				'condition' => [
					'ma_el_restrict_content_type'	=> 'age_restrict',
					'ma_el_restrict_age_type'	=> ['age_checkbox', 'button_confirm']
				]
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Close Button Color', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'separator'  => 'before',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Warning Message BG', JLTMA_TD),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-message-text .ma-el-alert,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-message-text .ma-el-alert' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-message-text .ma-el-alert,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-message-text .ma-el-alert' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-message-text .ma-el-alert,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-message-text .ma-el-alert' => 'Margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Password Input', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'ma_el_restrict_content_type'	=> 'password'
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator'  => 'before',
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'separator' => 'before',
				'selector'  => '{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__('Radius', JLTMA_TD),
				'type'       => Controls_Manager::DIMENSIONS,
				'separator'  => 'after',
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass:hover' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass:hover' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass:hover' => 'border-color: {{VALUE}};'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-content-fields input.jltma-input-pass:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'separator' => 'before',
				'selector'  => '{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
									{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn:hover' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn:hover' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn:hover' => 'border-color: {{VALUE}};'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-content-fields button.ma-el-btn:hover,
									{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields button.ma-el-btn:hover',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Exit Button', JLTMA_TD),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'ma_el_restrict_content_type'	=> 'age_restrict',
					'ma_el_restrict_age_type'	=> 'button_confirm'
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'separator' => 'before',
				'selector'  => '{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
									{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn, {{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover' => 'background: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover' => 'border-color: {{VALUE}};'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover,
									{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-content-fields .ma-el-exit.ma-el-btn:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .jltma-restrict-form .jltma_rc_result,
						{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .jltma_rc_result' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jltma-restrict-form .jltma_rc_result,
					{{WRAPPER}} {{CURRENT_ITEM}} .jltma-restrict-form .jltma_rc_result',
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/restrict-content-for-elementor/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/restrict-content-for-elementor/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Watch Video Tutorial %2$s', JLTMA_TD), '<a href="https://www.youtube.com/watch?v=Alc1R_W5_Z8" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		$this->end_controls_section();
...
?>
		<div class="jltma-restrict-content-message">
			<?php
			if ($settings['ma_el_warning_type'] == 'custom') {
				if (!isset($_POST['ma_el_restrict_content_pass'])) {

					if (!empty($settings['ma_el_warning_message_text'])) {
						if ($settings['ma_el_warning_show'] == 'yes') { ?>
							<div class="jltma-restrict-content-message-text">
			...
			<?php }
					} elseif (!empty($_POST['ma_el_restrict_content_pass']) && ($settings['ma_el_restrict_content_pass'] !== $_POST['ma_el_restrict_content_pass'])) {
						if ($settings['ma_el_warning_show'] == 'yes') {
							Master_Addons_Helper::jltma_warning_messaage(esc_html__('Ops, You entered wrong password!', JLTMA_TD), 'warning', $close_button);
						}
					}
				} elseif ('elementor' == $settings['ma_el_warning_type'] and !empty($settings['ma_el_warning_message_template'])) {
					echo Master_Addons_Helper::jltma_elementor()->frontend->get_builder_content_for_display($settings['ma_el_warning_message_template']);
				}
			} ?>
		</div>
	<?php
	...
	public function jltma_restrict_content()
	{
		$settings = $this->get_settings_for_display();
	?>
		<div class="jltma-restrict-content">
			<?php
	...
	?>
		...
		<div class="form-group mb-2">
			<input type="password" name="ma_el_restrict_content_pass" class="form-control jltma-input-pass mr-3 mt-2" placeholder="<?php echo esc_attr($settings['ma_el_password_field_placeholder']); ?>" size="20" />
	...
	?>
		...
		<div id="jltma_rc_checkbox" class="form-group form-check">
	...
	public function jltma_rc_enter_age()
	{
		$settings = $this->get_settings_for_display();
	?>
		<div class="form-group my-1 mr-2 jltma_rc_year">
	...
	?>
		<div id="ma_el_dob">
			...
			<div class="jltma_ra_select_wrap">
				<div class='jltma_ra_select'>
	...
	?>
		...
		<div class="form-group text-center jltma_rc_answer">
			<label for="jltma_rc_answer" class="jltma_rc_answer">
				<?php echo $settings['ma_el_warning_message_title']; ?> <?php echo $math . ' =   '; ?>
			</label>
			<input class="mt-1 mr-3 ml-3" name="jltma_rc_answer" type="text" size="8" /><br />
			<input name="jltma_rc_answer_hd" type="hidden" value="<?php echo $math_hd; ?>" />
	...
	public function jltma_restrict_content_form()
	{
		...
		$this->add_render_attribute([
			'form_wrapper' => [
				...
				'id' 			=> 'jltma-restrict-form-' . $this->get_id(),
				'data-form-id' 	=> 'jltma-restrict-form-' . $this->get_id(),
				'method'		=> "post"
			],
		]);
	...
	?>
		<div class="jltma-restrict-content-fields">
	...
	protected function render()
	{
		...
		$popup_content_link = '#jltma-restrict-content-popup-trigger-' . $this->get_id();

		$this->add_render_attribute([
			'wrapper' => [
				'class'						=> ['jltma-restrict-content-wrap'],
				'id' 						=> 'jltma-restrict-content-' . $this->get_id(),
			...
			'restrict_age' 	=> [
				'class'						=> ['jltma-restrict-age-wrapper', 'card', 'text-center'],
				'id' 						=> 'jltma-restrict-age-' . $this->get_id(),
			...
			'popup_trigger' => [
				'class'	=> [
					'jltma-restrict-content-popup-trigger',
					'ma-el-popup-trigger',
			...
			'popup_content' => [
				'class'	=> [
					'ma-el-popup-content',
					'jltma-restrict-content-popup-content'
				],
				'id' => '#jltma-restrict-content-popup-trigger-' . $this->get_id(),
		...
		<section <?php echo $this->get_render_attribute_string('wrapper'); ?>>
			...
			if ($settings['ma_el_restrict_content_layout_type'] == 'popup') { ?>
				...
				<div <?php echo $this->get_render_attribute_string('popup_content'); ?>>
					...
					<p class="mb-0 jltma-rc-button d-block">
						<a data-fancybox data-width="800" data-height="450" data-animation-duration="700" data-animation-effect="material" data-modal="<?php if ($settings['ma_el_restrict_content_popup_type'] == "buttonfullscreen" || $settings['ma_el_restrict_content_popup_type'] == "windowloadfullscreen") {
																																							...
																																							echo 'false';
																																						} ?>" data-src="#jltma-rc-modal-<?php echo $this->get_id(); ?>" data-options='{
											...
											}' href="javascript:;" class="jltma-btn jltma-rc-button" id="<?php if ($settings['ma_el_restrict_content_popup_type'] == "windowload" || $settings['ma_el_restrict_content_popup_type'] == "windowloadfullscreen") {
																												echo "jltma-rc-modal-hidden";
																											} else {
																												echo "jltma-rc-button";
																											} ?>">
					...
					<div style="display: none;" id="jltma-rc-modal-<?php echo $this->get_id(); ?>" class="jltma-restrict-modal <?php echo $settings['ma_el_restrict_content_popup_type']; ?>">
