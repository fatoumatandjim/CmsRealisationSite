    ...
    class JLTMA_Addon_Extensions
    {
        ...
        public function __construct()
        {
            self::$jltma_extensions = [
                'jltma-extensions'         => [
                    'title'     => esc_html__('Extensions', JLTMA_TD),
                    'extension' => [
                        [
                            'key'      => 'particles',
                            'title'    => esc_html__('Particles', JLTMA_TD),
                        ...
                        [
                            ...
                            'title'    => esc_html__('Animated Gradient BG', JLTMA_TD),
                        ...
                        [
                            ...
                            'title'    => esc_html__('Reading Progress Bar', JLTMA_TD),
                        ...
                        [
                            'key'      => 'bg-slider',
                            'title'    => esc_html__('Background Slider', JLTMA_TD),
                        ...
                        [
                            'key'      => 'custom-css',
                            'title'    => esc_html__('Custom CSS', JLTMA_TD),
                        ...
                        [
                            'key'      => 'custom-js',
                            'title'    => esc_html__('Custom JS', JLTMA_TD),
                        ...
                        [
                            'key'      => 'positioning',
                            'title'    => esc_html__('Positioning', JLTMA_TD),
                        ...
                        [
                            'key'      => 'extras',
                            'title'    => esc_html__('Container Extras', JLTMA_TD),
                        ...
                        [
                            'key'      => 'mega-menu',
                            'title'    => esc_html__('Mega Menu', JLTMA_TD),
                        ...
                        [
                            'key'      => 'transition',
                            'title'    => esc_html__('Entrance Animation', JLTMA_TD),
                        ...
                        [
                            'key'      => 'transforms',
                            'title'    => esc_html__('Transforms', JLTMA_TD),
                        ...
                        [
                            'key'      => 'rellax',
                            'title'    => esc_html__('Rellax', JLTMA_TD),
                        ...
                        [
                            'key'      => 'reveal',
                            'title'    => esc_html__('Reveal', JLTMA_TD),
                        ...
                        [
                            ...
                            'title'    => esc_html__('Header,Footer,Comment Form', JLTMA_TD),
                        ...
                        [
                            ...
                            'title'    => esc_html__('Display Conditions', JLTMA_TD),
                        ...
                        [
                            'key'      => 'dynamic-tags',
                            'title'    => esc_html__('Dynamic Tags', JLTMA_TD),
                        ...
                        [
                            ...
                            'title'    => esc_html__('Floating Effects', JLTMA_TD),
                        ...
                        [
                            'key'      => 'wrapper-link',
                            'title'    => esc_html__('Wrapper Link', JLTMA_TD),
                        ...
                        [
                            'key'      => 'duplicator',
                            'title'    => esc_html__('Post/Page Duplicator', JLTMA_TD),
                        ...
                        [
                            'key'      => 'glassmorphism',
                            'title'    => esc_html__('Glassmorphism', JLTMA_TD),
                        ...
                        [
                            'key'      => 'icons-extended',
                            'title'    => esc_html__('Icons Manager', JLTMA_TD),
                            'class'    => 'MasterAddons\Modules\JLTMA_Extension_Icons_Manager',
                            'demo_url' => '',
                            'docs_url' => '',
                            'tuts_url' => '',
                            'is_pro'   => false
                        ...
                        // [
                        //     'key'      => 'ribbon',
                        //     'title'    => esc_html__('Ribbon', JLTMA_TD),
                        ...
                        // [
                        //     'key'      => 'tooltips',
                        //     'title'    => esc_html__('Tooltips', JLTMA_TD),
                        ...
                        // [
                        //     'key'           => 'nested-sections',
                        //     'title'         => esc_html__('Nested Sections', JLTMA_TD),
                        ...
                        // [
                        //     'key'           => 'sticky',
                        //     'title'         => esc_html__('Sticky', JLTMA_TD),
                        ...
                        //     'title'         => esc_html__('Content Protection', JLTMA_TD),
                        ...
                        //     'title'         => esc_html__( 'Morphing Effects', JLTMA_TD),
                        ...
                        // [
                        //     'key'           => 'magic-copy',
                        //     'title'         => esc_html__( 'Live Copy', JLTMA_TD),
