...
class JLTMA_Extension_Floating_Effects extends JLTMA_Extension_Prototype
{
	...
	private function add_controls($element, $args)
	{
		...
		$element->add_control(
			...
			[
				'label' 				=> __('Floating Effects', JLTMA_TD),
	...
	{
		// wp_enqueue_script('jltma-floating-effects', JLTMA_URL . '/assets/vendor/floating-effects/floating-effects.js', array('ma-el-anime-lib', 'jquery'), JLTMA_VER);
	}
