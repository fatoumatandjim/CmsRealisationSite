...
class JLTMA_Display_Conditions extends JLTMA_Extension_Prototype
{
	...
	private function set_conditions_options()
	{
		...
		$this->conditions_options = [
			[
				'label'		=> esc_html__('Visitor', JLTMA_TD),
				'options' 	=> [
					'authentication' 	=> esc_html__('Login Status', JLTMA_TD),
					'role' 				=> esc_html__('User Role', JLTMA_TD),
					'os' 				=> esc_html__('Operating System', JLTMA_TD),
					'browser' 			=> esc_html__('Browser', JLTMA_TD),
				],
			],
			[
				'label'			=> esc_html__('Date & Time', JLTMA_TD),
				'options' 		=> [
					'date' 		=> esc_html__('Current Date', JLTMA_TD),
					'time' 		=> esc_html__('Time of Day', JLTMA_TD),
					'day' 		=> esc_html__('Day of Week', JLTMA_TD),
				],
			],
			[
				'label'					=> esc_html__('Single', JLTMA_TD),
				'options' 				=> [
					'page' 				=> esc_html__('Page', JLTMA_TD),
					'post' 				=> esc_html__('Post', JLTMA_TD),
					'static_page' 		=> esc_html__('Static Page', JLTMA_TD),
					'post_type' 		=> esc_html__('Post Type', JLTMA_TD),
				],
			],
			[
				'label'					=> esc_html__('Archive', JLTMA_TD),
				'options' 				=> [
					'taxonomy_archive' 	=> esc_html__('Taxonomy', JLTMA_TD),
					'term_archive' 		=> esc_html__('Term', JLTMA_TD),
					'post_type_archive'	=> esc_html__('Post Type', JLTMA_TD),
					'date_archive'		=> esc_html__('Date', JLTMA_TD),
					'author_archive'	=> esc_html__('Author', JLTMA_TD),
					'search_results'	=> esc_html__('Search', JLTMA_TD),
				],
			],
		];
		...
		if (class_exists('Easy_Digital_Downloads', false)) {
			$this->conditions_options[] = [
				'label'					=> esc_html__('Easy Digital Downloads', JLTMA_TD),
				'options' 				=> [
					'edd_cart' 			=> esc_html__('Cart', JLTMA_TD),
				],
			];
		}
	}
	...
	private function add_controls($element, $args)
	{
		...
		$element->add_control(
			...
			[
				'label'              => esc_html__('Display Conditions', JLTMA_TD),
		...
		if ('widget' === $element_type) {
			$element->add_control(
				...
				[
					'label'              => esc_html__('Output HTML', JLTMA_TD),
					'description'        => sprintf(esc_html__('If enabled, the HTML code will exist on the page but the %s will be hidden using CSS.', JLTMA_TD), $element_type),
					'default'            => 'yes',
					'type'               => Controls_Manager::SWITCHER,
					'label_on'           => esc_html__('Yes', JLTMA_TD),
					'label_off'          => esc_html__('No', JLTMA_TD),
		...
		$element->add_control(
			...
			[
				'label'   => esc_html__('Display on', JLTMA_TD),
				'type'    => Controls_Manager::SELECT,
				'default' => 'all',
				'options' => [
					'all' => esc_html__('All conditions met', JLTMA_TD),
					'any' => esc_html__('Any condition met', JLTMA_TD),
				],
				'condition'	=> [
					'jltma_display_conditions_enable' => 'yes',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' 	=> true,
				'options' 		=> [
					'is' 		=> esc_html__('Is', JLTMA_TD),
					'not' 		=> esc_html__('Is not', JLTMA_TD),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'options' 	=> [
					'authenticated' => esc_html__('Logged in', JLTMA_TD),
				],
				'condition' => [
		...
		$repeater->add_control(
			...
			[
				'type' 			=> Controls_Manager::SELECT,
				'description' 	=> esc_html__('Warning: This condition applies only to logged in visitors.', JLTMA_TD),
				'default' 		=> 'subscriber',
				'label_block' 	=> true,
		...
		$repeater->add_control(
			...
			[
				'label'		=> esc_html__('In interval', JLTMA_TD),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__('Any', JLTMA_TD),
				'multiple'    => true,
				'options'     => [
					'1' => esc_html__('Monday', JLTMA_TD),
					'2' => esc_html__('Tuesday', JLTMA_TD),
					'3' => esc_html__('Wednesday', JLTMA_TD),
					'4' => esc_html__('Thursday', JLTMA_TD),
					'5' => esc_html__('Friday', JLTMA_TD),
					'6' => esc_html__('Saturday', JLTMA_TD),
					'7' => esc_html__('Sunday', JLTMA_TD),
				],
				'label_block' => true,
				'default'     => 'Monday',
				'condition'   => [
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank for any page.', JLTMA_TD),
				'label_block' 	=> true,
				'multiple'		=> true,
				'query_type'	=> 'posts',
				'object_type'	=> 'page',
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank for any post.', JLTMA_TD),
				'label_block' 	=> true,
				'multiple'		=> true,
				'query_type'	=> 'posts',
				'object_type'	=> '',
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' 	=> true,
				'options' 		=> [
					'home'		=> esc_html__('Default Homepage', JLTMA_TD),
					'static'	=> esc_html__('Static Homepage', JLTMA_TD),
					'blog'		=> esc_html__('Blog Page', JLTMA_TD),
					'404'		=> esc_html__('404 Page', JLTMA_TD),
				],
				'condition' 	=> [
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank or select all for any post type.', JLTMA_TD),
				'label_block' 	=> true,
				'multiple'		=> true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank or select all for any taxonomy archive.', JLTMA_TD),
				'multiple'		=> true,
				'label_block' 	=> true,
		...
		$repeater->add_control(
			...
			[
				...
				'description'	=> esc_html__('Leave blank or select all for any term archive.', JLTMA_TD),
				'type' 			=> 'jltma_query',
				'post_type' 	=> '',
				'options' 		=> [],
				'label_block' 	=> true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank or select all for any date based archive.', JLTMA_TD),
				'multiple'		=> true,
				'label_block' 	=> true,
				'options' 		=> [
					'day'		=> esc_html__('Day', JLTMA_TD),
					'month'		=> esc_html__('Month', JLTMA_TD),
					'year'		=> esc_html__('Year', JLTMA_TD),
				],
				'condition' 	=> [
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Any', JLTMA_TD),
				'description'	=> esc_html__('Leave blank for all authors.', JLTMA_TD),
				'multiple'		=> true,
				'label_block' 	=> true,
				'query_type'	=> 'authors',
				'condition' 	=> [
		...
		$repeater->add_control(
			...
			[
				...
				'default' 		=> '',
				'placeholder'	=> esc_html__('Keywords', JLTMA_TD),
				'description'	=> esc_html__('Enter keywords, separated by commas, to condition the display on specific keywords and leave blank for any.', JLTMA_TD),
				'label_block' 	=> true,
				'condition' 	=> [
		...
		if (class_exists('Easy_Digital_Downloads', false)) {
			$repeater->add_control(
				...
				[
					...
					'label_block' 	=> true,
					'options' 		=> [
						'empty'		=> esc_html__('Empty', JLTMA_TD),
					],
					'condition' 	=> [
		...
		$element->add_control(
			...
			[
				'label'   => esc_html__('Conditions', JLTMA_TD),
	...
	{
?><span>
			<?php echo esc_html__('This widget is displayed conditionally.', JLTMA_TD); ?></span>
<?php
	}
