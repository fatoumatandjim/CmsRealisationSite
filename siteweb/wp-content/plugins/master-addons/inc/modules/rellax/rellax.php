...
class JLTMA_Extension_Rellax extends JLTMA_Extension_Prototype
{
    ...
    private function add_controls($element, $args)
    {
        ...
        $element->add_control(
            'enabled_rellax',
            [
                'label' => __('Enabled Rellax', JLTMA_TD),
    ...
    {
        wp_enqueue_script('ma-el-rellaxjs-libs', JLTMA_URL . '/assets/vendor/rellax/rellax.min.js', array('jquery'), JLTMA_VER, true);
    }
