...
class JLTMA_Transform_Extension extends JLTMA_Extension_Prototype
{
    ...
    private function add_controls($element, $args)
    {
        ...
        $element->add_control(
            'enabled_transform',
            [
                'label' => __('Enabled Transforms', JLTMA_TD),
        ...
        $element->add_control(
            ...
            [
                'label' => __('Transition Duration (seconds)', JLTMA_TD),
                'type' => Controls_Manager::SLIDER,
                'separator' => 'before',
                'size_units' => ['px'],
                'range' => [
...
JLTMA_Transform_Extension::get_instance();