...
class JLTMA_Extension_Reveal extends JLTMA_Extension_Prototype
{
    ...
    private function add_controls($element, $args)
    {
        ...
        $element->add_control(
            'enabled_reveal',
            [
                'label' => __('Enabled Reveal', JLTMA_TD),
        ...
        $element->add_control(
            ...
            [
                ...
                'default' => 'c',
                'options' => [
                    'c' => __('Center', JLTMA_TD),
                    'lr' => __('Left to Right', JLTMA_TD),
                    'rl' => __('Right to Left', JLTMA_TD),
                    'tb' => __('Top to Bottom', JLTMA_TD),
                    'bt' => __('Bottom to top', JLTMA_TD),
                ],
                'frontend_available' => true,
                'condition' => [
                    'enabled_reveal' => 'yes'
